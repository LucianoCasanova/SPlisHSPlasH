...
SimulationDataVdWSPH::SimulationDataVdWSPH() :
	m_pressure(),
	m_pressureAccel()
{
}

SimulationDataVdWSPH::~SimulationDataVdWSPH(void)
{
	cleanup();
}

void SimulationDataVdWSPH::init()
{
...
void SimulationDataVdWSPH::cleanup()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataVdWSPH::reset()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataVdWSPH::performNeighborhoodSearchSort()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataVdWSPH::emittedParticles(FluidModel* model, const unsigned int startIndex)
{
