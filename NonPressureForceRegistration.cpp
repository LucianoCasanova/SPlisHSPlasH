...
#include "SurfaceTension/SurfaceTension_vdW.h"
#include "SurfaceTension/SurfaceTension_Blank2024.h"
#include "SurfaceTension/SurfaceTension_Li2018.h"
#include "SurfaceTension/SurfaceTension_Tartakovsky2016.h"
...
void Simulation::registerNonpressureForces()
{
	...
	addSurfaceTensionMethod("van der Waals", SurfaceTension_vdW::creator);
	addSurfaceTensionMethod("Blank et al. 2024", SurfaceTension_Blank2024::creator);
	addSurfaceTensionMethod("Li et al. 2018", SurfaceTension_Li2018::creator);
	addSurfaceTensionMethod("Tartakovsky et al. 2016", SurfaceTension_Tartakovsky2016::creator);
#ifdef USE_THIRD_PARTY_METHODS
