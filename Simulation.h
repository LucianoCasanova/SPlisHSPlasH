...
namespace SPH
{
	enum class SimulationMethods { WCSPH = 0, PCISPH, PBF, IISPH, DFSPH, PF, ICSPH, VdWSPH, ISPH, NumSimulationMethods };
	...
	*/
	...
	public:
		...
		static int ENUM_SIMULATION_VdWSPH;
		static int ENUM_SIMULATION_ISPH;
